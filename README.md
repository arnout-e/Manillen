...
- **Advies met uitleg**: bij elke beurt zie je de aangeraden kaart, de reden in gewone taal ("je maat wint zeker: smeren", "hoogste troef die nog meedoet", "geef geen punten weg") en een tabel met alle toegelaten kaarten.
...
De tests dekken de slagregels (volgen, hoger leggen, troeven, overtroeven, sans), de telling, en het advies (altijd een toegelaten kaart, smeren, niet weggeven, goedkoop winnen, troefkeuze).
...
- Oefenreeksen rond één thema: smeren, troef trekken, tellen.
